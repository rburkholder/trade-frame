...
void PanelStatistics::CreateControls() {
  ...
  PanelStatistics* itemPanel1 = this;
    ...
    wxStaticText* itemStaticText2 = new wxStaticText( itemPanel1, wxID_STATIC, _("ticks"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxStaticText* itemStaticText6 = new wxStaticText( itemPanel1, wxID_STATIC, _("bid"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxStaticText* itemStaticText8 = new wxStaticText( itemPanel1, wxID_STATIC, _("ask"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxStaticText* itemStaticText10 = new wxStaticText( itemPanel1, wxID_STATIC, _("ttl"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer4->Add(itemStaticText10, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1);
    ...
    wxStaticText* itemStaticText14 = new wxStaticText( itemPanel1, wxID_STATIC, _("bid"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxStaticText* itemStaticText16 = new wxStaticText( itemPanel1, wxID_STATIC, _("ask"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer12->Add(itemStaticText16, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1);
    ...
    wxStaticText* itemStaticText18 = new wxStaticText( itemPanel1, wxID_STATIC, _("ttl"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer12->Add(itemStaticText18, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1);
    ...
    itemBoxSizer20->Add(itemStaticText22, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1);
    ...
    itemBoxSizer20->Add(itemStaticText24, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1);
    ...
    itemBoxSizer20->Add(itemStaticText26, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1);
    ...
    wxStaticText* itemStaticText30 = new wxStaticText( itemPanel1, wxID_STATIC, _("bid"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer28->Add(itemStaticText30, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1);
    ...
    wxStaticText* itemStaticText32 = new wxStaticText( itemPanel1, wxID_STATIC, _("ask"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer28->Add(itemStaticText32, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1);
    ...
    wxStaticText* itemStaticText34 = new wxStaticText( itemPanel1, wxID_STATIC, _("ttl"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer28->Add(itemStaticText34, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1);
