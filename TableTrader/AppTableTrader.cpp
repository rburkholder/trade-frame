...
void AppTableTrader::HomeRoot( Wt::WContainerWidget* pcw ) {
  ...
  namespace ph = std::placeholders;
  Page_Template( pcw, std::bind( &AppTableTrader::ShowMainMenu, this, ph::_1 ) );
}
...
void AppTableTrader::Page_Template( Wt::WContainerWidget* pcw, fTemplate_t f) {
...
void AppTableTrader::Page_TableTrader( Wt::WContainerWidget* pcw /* m_pContainerTableEntry */, const std::string& sDate  ) {
