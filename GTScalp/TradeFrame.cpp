...
CTradeFrame::CTradeFrame( CTradingLogic *pTradingLogic ) {
  ...
  theApp.m_pRefresh->OnRefresh.Add( MakeDelegate( this, &CTradeFrame::OnPeriodicRefresh ) );
...
CTradeFrame::~CTradeFrame() {
  ...
  theApp.m_pRefresh->OnRefresh.Remove( MakeDelegate( this, &CTradeFrame::OnPeriodicRefresh ) );
}
