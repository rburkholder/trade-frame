...
Worker::Worker(void): m_dm( ou::tf::HDF5DataManager::RO ) {
...
void Worker::CheckForDarvas( const std::string& sSymbol, citer begin, citer end ) {
...
void Worker::CheckFor10Percent( const std::string& sSymbol, citer begin, citer end ) {
...
void Worker::WrapUp10Percent( void ) {
...
void Worker::CheckForVolatility( const std::string& sSymbol, citer begin, citer end ) {
  double dblAveragePrice = std::for_each( begin, end, AveragePrice() );
  citer iterLast( end - 1 );
  if ( 25.0 < dblAveragePrice ) {
...
void Worker::WrapUpVolatility( void ) {
