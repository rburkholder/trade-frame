...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/intervalsampler: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/intervalsampler ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/IntervalSampler.o: IntervalSampler.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IntervalSampler.o IntervalSampler.cpp

${OBJECTDIR}/ReadSymbolFile.o: ReadSymbolFile.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReadSymbolFile.o ReadSymbolFile.cpp
