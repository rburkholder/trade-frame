...
, fCallBack_t&& fDisconnecting, fCallBack_t&& fDisconnected
  ...
  widgets.m_sizer->Add(widgets.m_cbD1, 0, wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP|wxBOTTOM, 5);
  ...
  widgets.m_sizer->Add(widgets.m_cbD2, 0, wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM, 5);
  ...
  widgets.m_sizer->Add(widgets.m_cbX1, 0, wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM, 5);
  ...
  widgets.m_sizer->Add(widgets.m_cbX2, 0, wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM, 5);
  ...
  widgets.m_sizer->Add(widgets.m_btnState, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);
  ...
  widgets.m_sizer->Layout();
  widgets.m_sizer->Show( true );

  m_sizerPanel->Add(widgets.m_sizer, 0, wxEXPAND|wxALL, 5);

  m_sizerPanel->Layout();
  m_sizerPanel->Show( true );
