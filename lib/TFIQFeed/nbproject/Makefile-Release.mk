...
${OBJECTDIR}/BuildInstrument.o: BuildInstrument.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BuildInstrument.o BuildInstrument.cpp

${OBJECTDIR}/BuildSymbolName.o: BuildSymbolName.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BuildSymbolName.o BuildSymbolName.cpp

${OBJECTDIR}/CurlGetMktSymbols.o: CurlGetMktSymbols.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CurlGetMktSymbols.o CurlGetMktSymbols.cpp

${OBJECTDIR}/IQFeed.o: IQFeed.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IQFeed.o IQFeed.cpp

${OBJECTDIR}/IQFeedMessages.o: IQFeedMessages.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IQFeedMessages.o IQFeedMessages.cpp

${OBJECTDIR}/IQFeedProvider.o: IQFeedProvider.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IQFeedProvider.o IQFeedProvider.cpp

${OBJECTDIR}/IQFeedSymbol.o: IQFeedSymbol.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IQFeedSymbol.o IQFeedSymbol.cpp

${OBJECTDIR}/InMemoryMktSymbolList.o: InMemoryMktSymbolList.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InMemoryMktSymbolList.o InMemoryMktSymbolList.cpp

${OBJECTDIR}/LoadMktSymbols.o: LoadMktSymbols.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LoadMktSymbols.o LoadMktSymbols.cpp

${OBJECTDIR}/MarketSymbol.o: MarketSymbol.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MarketSymbol.o MarketSymbol.cpp

${OBJECTDIR}/MarketSymbols.o: MarketSymbols.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MarketSymbols.o MarketSymbols.cpp
...
${OBJECTDIR}/OptionChainQuery.o: OptionChainQuery.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OptionChainQuery.o OptionChainQuery.cpp

${OBJECTDIR}/ParseMktSymbolDiskFile.o: ParseMktSymbolDiskFile.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ParseMktSymbolDiskFile.o ParseMktSymbolDiskFile.cpp

${OBJECTDIR}/ParseMktSymbolLine.o: ParseMktSymbolLine.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ParseMktSymbolLine.o ParseMktSymbolLine.cpp

${OBJECTDIR}/UnzipMktSymbols.o: UnzipMktSymbols.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UnzipMktSymbols.o UnzipMktSymbols.cpp

${OBJECTDIR}/ValidateMktSymbolLine.o: ValidateMktSymbolLine.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ValidateMktSymbolLine.o ValidateMktSymbolLine.cpp
