...
${OBJECTDIR}/HistoryDailyTick.o: HistoryDailyTick.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HistoryDailyTick.o HistoryDailyTick.cpp

${OBJECTDIR}/MarketStates.o: MarketStates.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MarketStates.o MarketStates.cpp
