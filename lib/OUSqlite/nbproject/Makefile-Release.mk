...
${OBJECTDIR}/Actions.o: Actions.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Actions.o Actions.cpp

${OBJECTDIR}/ISqlite3.o: ISqlite3.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ISqlite3.o ISqlite3.cpp

${OBJECTDIR}/Session.o: Session.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Session.o Session.cpp
