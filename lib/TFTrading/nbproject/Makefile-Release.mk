...
${OBJECTDIR}/AccountAdvisor.o: AccountAdvisor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AccountAdvisor.o AccountAdvisor.cpp

${OBJECTDIR}/AccountManager.o: AccountManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AccountManager.o AccountManager.cpp

${OBJECTDIR}/AccountOwner.o: AccountOwner.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AccountOwner.o AccountOwner.cpp

${OBJECTDIR}/AlternateInstrumentNames.o: AlternateInstrumentNames.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AlternateInstrumentNames.o AlternateInstrumentNames.cpp

${OBJECTDIR}/CashAccount.o: CashAccount.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CashAccount.o CashAccount.cpp

${OBJECTDIR}/CashManager.o: CashManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CashManager.o CashManager.cpp

${OBJECTDIR}/CashTransaction.o: CashTransaction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CashTransaction.o CashTransaction.cpp
...
${OBJECTDIR}/DBOps.o: DBOps.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DBOps.o DBOps.cpp

${OBJECTDIR}/DailyTradeTimeFrames.o: DailyTradeTimeFrames.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DailyTradeTimeFrames.o DailyTradeTimeFrames.cpp
...
${OBJECTDIR}/Exchange.o: Exchange.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Exchange.o Exchange.cpp

${OBJECTDIR}/Execution.o: Execution.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Execution.o Execution.cpp
...
${OBJECTDIR}/InstrumentData.o: InstrumentData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InstrumentData.o InstrumentData.cpp

${OBJECTDIR}/InstrumentManager.o: InstrumentManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InstrumentManager.o InstrumentManager.cpp
...
${OBJECTDIR}/NoRiskInterestRateSeries.o: NoRiskInterestRateSeries.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NoRiskInterestRateSeries.o NoRiskInterestRateSeries.cpp
...
${OBJECTDIR}/OrderManager.o: OrderManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OrderManager.o OrderManager.cpp

${OBJECTDIR}/OrdersOutstanding.o: OrdersOutstanding.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OrdersOutstanding.o OrdersOutstanding.cpp

${OBJECTDIR}/Portfolio.o: Portfolio.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Portfolio.o Portfolio.cpp

${OBJECTDIR}/PortfolioManager.o: PortfolioManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PortfolioManager.o PortfolioManager.cpp
...
${OBJECTDIR}/PositionCombo.o: PositionCombo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PositionCombo.o PositionCombo.cpp

${OBJECTDIR}/ProviderManager.o: ProviderManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProviderManager.o ProviderManager.cpp

${OBJECTDIR}/RiskManager.o: RiskManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RiskManager.o RiskManager.cpp
...
${OBJECTDIR}/TradingEnumerations.o: TradingEnumerations.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TradingEnumerations.o TradingEnumerations.cpp
