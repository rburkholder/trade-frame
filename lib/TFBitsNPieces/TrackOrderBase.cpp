...
// unused
void TrackOrderBase::HandleExitOrderCancelled( const ou::tf::Order& order ) {
  ou::tf::Order& order_( const_cast<ou::tf::Order&>( order ) );
  order_.OnOrderCancelled.Remove( MakeDelegate( this, &TrackOrderBase::HandleExitOrderCancelled ) );
  order_.OnOrderFilled.Remove( MakeDelegate( this, &TrackOrderBase::HandleExitOrderFilled ) );
...
// unused
void TrackOrderBase::HandleExitOrderFilled( const ou::tf::Order& order ) {
  ou::tf::Order& order_( const_cast<ou::tf::Order&>( order ) );
  order_.OnOrderCancelled.Remove( MakeDelegate( this, &TrackOrderBase::HandleExitOrderCancelled ) );
  order_.OnOrderFilled.Remove( MakeDelegate( this, &TrackOrderBase::HandleExitOrderFilled ) );
...
// unused
void TrackOrderBase::ExitPosition( const ou::tf::Quote& quote ) {
  pOrder_t pOrder;
  ...
  if ( m_pPosition->IsActive() ) {
    ...
    switch ( m_pPosition->GetRow().eOrderSideActive ) {
      case ou::tf::OrderSide::EOrderSide::Buy:
        ...
        pOrder->OnOrderCancelled.Add( MakeDelegate( this, &TrackOrderBase::HandleExitOrderCancelled ) );
        pOrder->OnOrderFilled.Add( MakeDelegate( this, &TrackOrderBase::HandleExitOrderFilled ) );
