...
${OBJECTDIR}/GridColumnSizer.o: GridColumnSizer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DwxUSE_GUI -I../ -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GridColumnSizer.o GridColumnSizer.cpp

${OBJECTDIR}/IQFeedInstrumentBuild.o: IQFeedInstrumentBuild.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DwxUSE_GUI -I../ -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IQFeedInstrumentBuild.o IQFeedInstrumentBuild.cpp
...
${OBJECTDIR}/Leg.o: Leg.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DwxUSE_GUI -I../ -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Leg.o Leg.cpp
