...
${OBJECTDIR}/GridColumnSizer.o: GridColumnSizer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -DwxUSE_GUI -I../ -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GridColumnSizer.o GridColumnSizer.cpp
...
${OBJECTDIR}/TreeOpsItems.o: TreeOpsItems.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -DwxUSE_GUI -I../ -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TreeOpsItems.o TreeOpsItems.cpp
