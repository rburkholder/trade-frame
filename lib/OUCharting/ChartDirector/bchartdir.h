...
CHARTDIR_DLLAPI void __cdecl CColorAxis_setColorGradient(ColorAxisInternal *ptr, bool isContinuous, const int *colorsData, int colorsLen, int overflowColor, int underflowColor);
...
CHARTDIR_DLLAPI BaseChartInternal * __cdecl SurfaceChart2BaseChart(SurfaceChartInternal *ptr);
...
CHARTDIR_DLLAPI void __cdecl CSurfaceChart_setPlotRegion(SurfaceChartInternal *ptr, int cx, int cy, int xWidth, int yDepth, int zHeight);
CHARTDIR_DLLAPI void __cdecl CSurfaceChart_setViewAngle(SurfaceChartInternal *ptr, double elevation, double rotation, double twist);
CHARTDIR_DLLAPI void __cdecl CSurfaceChart_setPerspective(SurfaceChartInternal *ptr, double perspective);
...
CHARTDIR_DLLAPI AxisInternal * __cdecl CSurfaceChart_xAxis(SurfaceChartInternal *ptr);
CHARTDIR_DLLAPI AxisInternal * __cdecl CSurfaceChart_yAxis(SurfaceChartInternal *ptr);
CHARTDIR_DLLAPI AxisInternal * __cdecl CSurfaceChart_zAxis(SurfaceChartInternal *ptr);
CHARTDIR_DLLAPI void __cdecl CSurfaceChart_setZAxisPos(SurfaceChartInternal *ptr, int pos);

CHARTDIR_DLLAPI ColorAxisInternal * __cdecl CSurfaceChart_setColorAxis(SurfaceChartInternal *ptr, int x, int y, int alignment, int length, int orientation);
CHARTDIR_DLLAPI ColorAxisInternal * __cdecl CSurfaceChart_colorAxis(SurfaceChartInternal *ptr);
	
CHARTDIR_DLLAPI void __cdecl CSurfaceChart_setWallVisibility(SurfaceChartInternal *ptr, bool xyVisible, bool yzVisible, bool zxVisible);
CHARTDIR_DLLAPI void __cdecl CSurfaceChart_setWallColor(SurfaceChartInternal *ptr, int xyColor, int yzColor, int zxColor, int borderColor);
CHARTDIR_DLLAPI void __cdecl CSurfaceChart_setWallThickness(SurfaceChartInternal *ptr, int xyThickness, int yzThickness, int zxThickness);
CHARTDIR_DLLAPI void __cdecl CSurfaceChart_setWallGrid(SurfaceChartInternal *ptr, int majorXGridColor, int majorYGridColor, int majorZGridColor,
