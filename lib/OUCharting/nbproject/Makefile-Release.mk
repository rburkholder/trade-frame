...
${OBJECTDIR}/ChartDVBasics.o: ChartDVBasics.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ChartDVBasics.o ChartDVBasics.cpp

${OBJECTDIR}/ChartDataView.o: ChartDataView.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ChartDataView.o ChartDataView.cpp

${OBJECTDIR}/ChartEntryBars.o: ChartEntryBars.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ChartEntryBars.o ChartEntryBars.cpp

${OBJECTDIR}/ChartEntryBase.o: ChartEntryBase.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ChartEntryBase.o ChartEntryBase.cpp

${OBJECTDIR}/ChartEntryIndicator.o: ChartEntryIndicator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ChartEntryIndicator.o ChartEntryIndicator.cpp

${OBJECTDIR}/ChartEntryMark.o: ChartEntryMark.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ChartEntryMark.o ChartEntryMark.cpp

${OBJECTDIR}/ChartEntryPrice.o: ChartEntryPrice.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ChartEntryPrice.o ChartEntryPrice.cpp

${OBJECTDIR}/ChartEntrySegments.o: ChartEntrySegments.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ChartEntrySegments.o ChartEntrySegments.cpp

${OBJECTDIR}/ChartEntryShape.o: ChartEntryShape.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ChartEntryShape.o ChartEntryShape.cpp

${OBJECTDIR}/ChartEntryVolume.o: ChartEntryVolume.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ChartEntryVolume.o ChartEntryVolume.cpp

${OBJECTDIR}/ChartMaster.o: ChartMaster.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ChartMaster.o ChartMaster.cpp
