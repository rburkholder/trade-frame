...
${OBJECTDIR}/Hdf5Chart.o: Hdf5Chart.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -DwxUSE_GUI -I../lib -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Hdf5Chart.o Hdf5Chart.cpp
