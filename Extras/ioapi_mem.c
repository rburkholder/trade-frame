...
long ZCALLBACK fseek64_mem_func (opaque, stream, offset, origin)
   voidpf opaque;
   voidpf stream;
   ZPOS64_T offset;
   int origin;
...
void fill_memory_filefunc64 (pzlib_filefunc_def, ourmem)
  zlib_filefunc64_def* pzlib_filefunc_def;
  ourmemory_t *ourmem;
{
    pzlib_filefunc_def->zopen64_file = fopen_mem_func;
//    pzlib_filefunc_def->zopendisk64_file = fopendisk_mem_func;
    pzlib_filefunc_def->zread_file = fread_mem_func;
    pzlib_filefunc_def->zwrite_file = fwrite_mem_func;
